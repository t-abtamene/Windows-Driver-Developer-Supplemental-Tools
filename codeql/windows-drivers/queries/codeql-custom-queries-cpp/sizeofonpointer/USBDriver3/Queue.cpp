...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, USBDriver3QueueInitialize)
#endif

NTSTATUS
USBDriver3QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = USBDriver3EvtIoDeviceControl;
    queueConfig.EvtIoStop = USBDriver3EvtIoStop;
